...
# Este archivo es el guardián de datos de la api, ya que define los esquemas de entrada y 
# salida para las rutas de autenticación.

# Importa las herramientas de Pydantic, que es la librería que usa FastApi para validar datos.
...
# ✅ NUEVOS SCHEMAS DE SOPORTE PARA ENVIAR DATOS DEL USUARIO EN EL LOGIN
...
class LoginResponse(BaseModel):
    message: str
    access_token: str
    refresh_token: str          # ✅ Agregado (tu servicio ya lo genera, ahora el schema lo acepta)
    token_type: str
    usuario: UsuarioResponse    # ✅ Agregado (para enviar nombre, email y rol al frontend)
