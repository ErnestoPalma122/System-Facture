...
# ✅ IMPORTANTE: Agregado para poder consultar los datos del usuario y su rol
from app.modules.usuarios.models import Usuario 
import logging

# Crea un registrador con el nombre del modulo actual, eso hace que aparezca en los logs del sistema,
# permitiendo identificar de donde provienen los mensajes de log.
logger = logging.getLogger(__name__)

# Define una ruta de prefijo para todas las rutas de autenticación, con el tag "Autenticación" 
# para la documentación de Swagger/OpenAPI.
...
@router.post(
    ...
    description="Autentica un usuario y retorna un token JWT con datos del usuario"
)
async def iniciar_sesion(
    ...
    try:
        # 1. Autenticar y obtener tokens del servicio
        result = login(db, credentials, ip_address, user_agent)
        
        # 2. ✅ CONSULTAR LA BASE DE DATOS para obtener el objeto usuario completo y su rol
